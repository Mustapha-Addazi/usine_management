                ...
                <div class="card-body">
                    <form  @submit.prevent="addConsumption">
                      <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="consumed">
                                Quantity Consumed* ({{ productUnit }})
                            </label>
                            <input type="number" id="consumed" step="0.01" v-model="form.consumed" placeholder="Enter the Quantity consumed" class="form-control">
